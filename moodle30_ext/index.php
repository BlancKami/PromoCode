...
echo '<head>
    ...
    <div class="frontpage_batch3">
        <a style="text-decoration:none;" href="/pages/about-us.php">
            <center>
                <div>
                    <img class="circular" src="/images/first-batch.jpg">
                </div>
            </center>
            <div class="homepage-button-text">
                Currently offering its first batch of courses through July 2016
            </div>
        </a>
    </div>

    <div class="frontpage_batch3">
        <a style="text-decoration:none;" href="http://www.fintechschool.com/meet-the-team.html" target="_blank">
            <center>
                <div>
                    <img class="circular" src="/images/instructors.jpg">
                </div>
            </center>
            <div class="homepage-button-text">
                Instructors and mentors who are seasoned Financial services professionals, entrepreneurs and thought leaders
            </div>
        </a>
    </div>

    <div class="frontpage_batch3">
        <a style="text-decoration:none;"href="/course/index.php">
            <center>
                <div>
                    <img class="circular" src="/images/category.jpg">
                </div>
            </center>
            <div class="homepage-button-text">
                100 - 400 level courses in different categories
            </div>
        </a>
    </div>
