...
//  Display the course home page.
    ...
    // theme >> snap >> renderers >> course >> toc_renderer.php
    ...
    <div style="right: 0px;
        position: absolute;
        font-family: \'Roboto\',\'Fira Sans\',\'Segoe UI\',
                \'HelveticaNeue-Light\',\'Helvetica Neue Light\',
                \'Helvetica Neue\',Helvetica,Arial,sans-serif;
        display: flex;">
        <div style="    margin-left: 0.5em;"><center> <a href="/mod/assign/index.php?id='.$course->id.'">
        <img src="/images/assignment.png" class="svg-icon" alt=""> Assignment</a></center></div>
        <div style="    margin-left: 0.5em;"><center> <a href="/mod/quiz/index.php?id='.$course->id.'"> 
        <img src="/images/quiz.png" class="svg-icon" alt="">Quiz</a></center></div>
        <div style="    margin-left: 0.5em;"><center> <a href="/mod/resource/index.php?id='.$course->id.'">
        <img src="/images/resources.png" class="svg-icon" alt=""> Resources</a></center></div>
        <div style="    margin-left: 0.5em;"><center> <a href="/mod/forum/index.php?id='.$course->id.'">
        <img src="/images/news.png" class="svg-icon" alt=""> News</a></center></div>
    </div>
    ';
    */
    ...
    /************************************
    *       adding left side pane       *
    *************************************/
    echo '
    <div style="width:7.6em;
        margin-left: -10em;
        float:left;
        font-family: \'Roboto\',\'Fira Sans\',\'Segoe UI\',
                \'HelveticaNeue-Light\',\'Helvetica Neue Light\',
        ...
        line-height: 1.75;
        margin-top: 6em;">
        <div> <a href="#about"> About the course</a></div>
        <div> <a href="#syllabus"> Syllabus</a></div>
        <div> <a href="#languages"> Languages</a></div>
        <div> <a href="#course_teachers"> Instructor</a></div>
        <div> <a href="#pre-requisites"> Pre-requisites</a></div>
        <div> <a href="#evaluation"> Evaluation</a></div>
    </div>
    ';

    $start_date = $DB->get_record('course', array('id'=>$course->id), '*', MUST_EXIST);
    echo '
    <div style="width:9em;
                margin-right: -13em;
                float:right;
        ...
        <div>
            <p style="font-size:0.9em; 
                      margin-bottom: -2px;">NEXT SESSION
            </p>
            <p style="font-size:1.3em;">'.date('d-M, Y',$start_date->startdate).'</p>
            <form autocomplete="off" action="/enrol/index.php?id='.$course->id.'" method="post"> 
                <button type="submit"
                        style="background-color: rgba(3, 169, 244,0.75);
                               width: 100%;
                               font-size: 1.5em;"> 
                    Enroll Me
                </button>
