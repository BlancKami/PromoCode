...
class toc_renderer extends core_renderer {
    ...
    public function course_toc() {
        ...
        // assignment, quiz, news and resources link
        $toc .= '<a href="/mod/assign/index.php?id='.$course->id.'">
            <img src="/images/assignment.png" class="svg-icon" alt="">Assignment</a>'; 

        $toc .= '<a href="/mod/quiz/index.php?id='.$course->id.'"> 
            <img src="/images/quiz.png" class="svg-icon" alt="">Quiz</a>';
        $toc .= '<a href="/mod/resource/index.php?id='.$course->id.'">
            <img src="/images/resources.png" class="svg-icon" alt="">Resources</a>';
        $toc .= '<a href="/mod/forum/index.php?id='.$course->id.'">
            <img src="/images/news.png" class="svg-icon" alt="">News</a>';
